  ...
  return (
    <div className="flex h-15 flex-row px-10 py-4 bg-gray-50 md:px-10 md:flex-col">
      <div className="flex grow flex-col justify-between space-y-2 md:flex-row md:space-y-0 md:space-x-2">
        ...
        <form>
          <button className="flex h-[48px] w-full grow items-center justify-center gap-2 rounded-md bg-gray-50 p-3 text-sm font-medium hover:bg-sky-100 hover:text-blue-600 md:flex-none md:w-auto md:justify-start md:p-2 md:px-3">
